...
const summaryCard: CSSProperties = { flex: 1, minWidth: 150, background: 'var(--bg-surface)', borderRadius: 10,
...
const bar: CSSProperties        = { width: 20, background: 'var(--color-brand-default)',
                                    borderRadius: '4px 4px 0 0', transition: 'height 0.3s' }
const barLabel: CSSProperties   = { fontSize: 10, color: 'var(--text-muted)',
...
const pagination: CSSProperties = { display: 'flex', alignItems: 'center', justifyContent: 'center',
                                    gap: 16, marginTop: 16 }
const pageBtn: CSSProperties    = { padding: '8px 18px', background: 'var(--bg-surface)',
