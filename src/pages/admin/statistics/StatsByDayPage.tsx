...
import { fetchStatistics, DAY_KR, DAY_ORDER } from '../../../api/statsApi'
import type { StatisticsDTO, DayOfWeek } from '../../../api/statsApi'
                      ...
                      <td style={td}>
                        {d.count > 0 ? (
                          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                            ...
                            <span style={{ fontSize: 12, color: 'var(--text-secondary)', minWidth: 34 }}>
                              {pct}%
                            </span>
                          </div>
                        ) : '-'}
...
const chartCard: CSSProperties = { background: 'var(--bg-surface)', borderRadius: 12,
